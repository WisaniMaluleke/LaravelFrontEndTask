<template>
    <div class="container-fluid">
        ...
        <nav
            class="fixed w-full z-20 top-0 start-0 border-b border-gray-500 dark:border-gray-600">
            <div class="flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button type="button"
                        class="text-white btn-outline rounded-lg text-sm px-4 py-2 text-center mr-1">
                        Sign Up
                      </button>
                    <button type="button"
